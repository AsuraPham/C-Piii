...
using projectDemo.Data.Mocks;

namespace projectDemo.Data.Mocks
{
    public class MockDrinkRepository : IDrinksReponsitory
    {
        private readonly ICategoryReponsitory _categoryRepository = new MockCategoryReponsitory();
